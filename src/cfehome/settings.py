...
EMAIL_HOST = config("EMAIL_HOST", cast=str, default="codemosedu@gmail.com")
...
ADMINS = [('YASH VAISHNAV', 'codegeek004@gmail.com')]
MANAGERS = ADMINS
...
print(STATICFILES_VENDOR_DIR, 'vendor dir')
